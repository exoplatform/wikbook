...
import org.wikbook.model.content.block.BlockQuotationElement;
import org.wikbook.model.content.block.DOMElement;
...
import org.wikbook.model.content.block.ProgramListingElement;
import org.wikbook.model.content.block.ScreenElement;
import org.wikbook.model.content.block.TableElement;
import org.wikbook.model.content.block.list.TermElement;
import org.wikbook.model.content.block.list.VariableListElement;
import org.wikbook.model.content.inline.AnchorElement;
import org.wikbook.model.content.inline.FormatElement;
import org.wikbook.model.content.inline.LinkElement;
import org.wikbook.model.content.inline.TextElement;
import org.wikbook.model.content.inline.TextFormat;
import org.wikbook.model.structural.BookElement;
import org.wikbook.model.structural.ComponentElement;
import org.wikbook.wiki.WikiLoader;
...
public class XDOMTransformer implements Listener
{
   ...
   public void beginList(ListType listType, Map<String, String> parameters)
   {
      ...
      book.push(new ListElement(listType, style));
   }
   ...
   public void beginLink(Link link, boolean isFreeStandingURI, Map<String, String> parameters)
   {
      switch (link.getType())
      {
         case URI:
            ...
            org.wikbook.model.content.inline.LinkType type;
            if (ref.startsWith("#"))
            {
               ref = ref.substring(1);
               type = org.wikbook.model.content.inline.LinkType.ANCHOR;
            }
            else
            {
               type = org.wikbook.model.content.inline.LinkType.URL;
            }
